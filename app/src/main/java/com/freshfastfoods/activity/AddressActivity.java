...
import com.freshfastfoods.model.Area;
import com.freshfastfoods.model.AreaD;
import com.freshfastfoods.model.UpdateAddress;
            ...
            if (callNo.equalsIgnoreCase("1")) {
                ...
                for (int i = 0; i < areaDS.size(); i++) {
                    if (areaDS.get(i).getStatus().equalsIgnoreCase("1")) {
                        ...
                        //sToast.makeText(AddressActivity.this, "" + areaDS.get(i).getName(), Toast.LENGTH_LONG).show();
                    }

                }
                //Toast.makeText(AddressActivity.this, "" + arrayList.size(), Toast.LENGTH_LONG).show();
